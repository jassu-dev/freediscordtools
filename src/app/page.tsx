    ...
    <>
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <section className="prose prose-invert max-w-none mb-12">
          <article>
            <h2 className="text-2xl font-bold text-[#F2F3F5] mb-4">The Complete Guide to Discord Utilities</h2>
            ...
            <h3 className="text-xl font-semibold text-[#F2F3F5] mb-3 mt-6">Understanding Discord Timestamps</h3>
            ...
            <p className="text-[#B9BBBE] mb-4">
              The syntax for a Discord timestamp is straightforward: <code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">&lt;t:UNIX_TIMESTAMP:FORMAT&gt;</code>. The UNIX_TIMESTAMP is a standard Unix timestamp — the number of seconds that have elapsed since January 1, 1970 at 00:00:00 UTC. The FORMAT is a single letter code that controls how Discord displays the date and time.
            </p>

            <p className="text-[#B9BBBE] mb-4">
              Discord supports seven different timestamp format codes, each producing a different visual representation. The short time format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">t</code>) displays just the hours and minutes, like &quot;3:04 PM&quot;. The long time format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">T</code>) adds seconds, producing &quot;3:04:05 PM&quot;. The short date format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">d</code>) shows the date as numbers, like &quot;01/01/2025&quot;. The long date format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">D</code>) writes out the full month name, like &quot;January 1, 2025&quot;.
            </p>

            <p className="text-[#B9BBBE] mb-4">
              The combined formats provide even more detail. The short date/time format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">f</code>) displays both the full date and time together, while the long date/time format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">F</code>) includes the full weekday name as well. The relative format (<code className="bg-[#2C2F33] px-1 rounded text-[#5865F2]">R</code>) is perhaps the most useful for event announcements — it shows a human-readable relative time like &quot;in 2 hours&quot;, &quot;3 days ago&quot;, or &quot;next week&quot;, and it updates in real time as time passes.
            </p>

            <h3 className="text-xl font-semibold text-[#F2F3F5] mb-3 mt-6">Why Discord Timestamps Matter for Communities</h3>
            ...
            <h3 className="text-xl font-semibold text-[#F2F3F5] mb-3 mt-6">How Unix Timestamps Work</h3>
            ...
            <h3 className="text-xl font-semibold text-[#F2F3F5] mb-3 mt-6">Discord Server Management Tips</h3>
            ...
            <h3 className="text-xl font-semibold text-[#F2F3F5] mb-3 mt-6">Using Discord for Community Building</h3>
            ...
            <h3 className="text-xl font-semibold text-[#F2F3F5] mb-3 mt-6">About FreeDiscordTools</h3>
        ...
        <section aria-labelledby="faq-heading" className="mb-12">
          <h2 id="faq-heading" className="text-2xl font-bold text-[#F2F3F5] mb-6">Frequently Asked Questions</h2>
          <div className="space-y-4">
            {homepageFaqs.map((faq, i) => (
              <details key={i} className="p-4 rounded-lg bg-[#2C2F33] border border-[#40444B] group">
