  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      ...
      <div className="text-[#5b6282] space-y-4">
        ...
        <h2 className="text-xl font-semibold text-[#1a1d2e] mt-6 mb-2">Use of Service</h2>
        ...
        <h2 className="text-xl font-semibold text-[#1a1d2e] mt-6 mb-2">Disclaimer of Warranties</h2>
        ...
        <h2 className="text-xl font-semibold text-[#1a1d2e] mt-6 mb-2">Limitation of Liability</h2>
        <p>FreeDiscordTools is not liable for any damages arising from your use of the site or its tools.</p>
        <h2 className="text-xl font-semibold text-[#1a1d2e] mt-6 mb-2">Changes to Terms</h2>
        ...
        <h2 className="text-xl font-semibold text-[#1a1d2e] mt-6 mb-2">Contact</h2>
